      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title"><strong>Maintanance List</strong></h3>
            <button class="btn btn-primary" style="float: right" data-toggle="modal" data-target="#CreateMaintenance">New Maintenance</button>
          </div>
          <div class="card-body">
