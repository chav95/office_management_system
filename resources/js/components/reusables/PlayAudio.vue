<template>
        <div class="player">
			<div class="player-controls d-flex h-100">
				...
				<div class="align-self-center">
					<a v-on:click.prevent="innerLoop = !innerLoop" href="#" title="Toggle Repeat File / Repeat Playlist">
						<svg width="18px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            download() {
                ...
                axios.get(this.file, { responseType: 'blob' })
                    .then(({ data }) => {
                        ...
                        link.download = this.judul;
                        link.click();
                        
                        axios.post(window.location.origin+'/api/log', this.postToLog)
                        .then(({ data }) => {
