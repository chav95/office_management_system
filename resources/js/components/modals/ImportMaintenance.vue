<template>
  <div class="container">
    <div class="modal fade" id="UploadMaintain" ref="modal" tabindex="-1" role="dialog" aria-labelledby="UploadMaintainLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <form @submit.prevent>
            <div class="modal-header">
              <h5 class="modal-title font-weight-bold" id="UploadMaintainLabel">Import From Excel</h5>
  ...
  export default {
    ...
    methods: {
      ...
      proceedAction() {
        ...
        axios.post(window.location.origin+'/api/maintenance', formData, {
